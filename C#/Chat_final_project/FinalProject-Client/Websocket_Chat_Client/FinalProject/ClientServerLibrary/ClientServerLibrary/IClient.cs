...
namespace ClientServerLibrary
{
    ...
    interface IClient
    {
        ...
        void SendChatID(int clientID, int chatID);
        ...
        void SendContactList(int clientID, List<String> contactList);
        ...
        void SendError(int clientID, string error);
        ...
        void SendLoginReply(int clientID, bool value);
        ...
        void SendNewContact(int clientID, string contactName);
        ...
        void SendUserStatus(int clientID, string username, bool isOnline);
        ...
        void SendMessage(int clientID, int chatID, string message);
    }
}
